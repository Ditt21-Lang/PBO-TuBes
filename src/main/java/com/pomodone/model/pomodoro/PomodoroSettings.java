...
public class PomodoroSettings {
    ...
    public PomodoroSettings(Duration focusDuration, Duration shortBreakDuration, Duration longBreakDuration, int roundsBeforeLongBreak) {
        ...
        if (shortBreakDuration == null || shortBreakDuration.isNegative())
            throw new IllegalArgumentException("Short break duration cannot be negative.");
        if (longBreakDuration == null || longBreakDuration.isNegative())
            throw new IllegalArgumentException("Long break duration cannot be negative.");
